...
const NotificationPage = () => {
  const [expandedNotification, setExpandedNotification] = useState(-1);
  ...
  const notifications = [
    {
      ...
      imageUrl: "./public/MicrosoftTeams-image-508.jpg", // Replace with your image URL
