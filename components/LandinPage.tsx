      ...
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-4xl font-extrabold leading-tight text-black dark:text-white sm:text-5xl sm:leading-tight md:text-6xl md:leading-tight">
                  Discover Top Tech Talent for Your Team
                </h1>
        ...
        <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            />
            <path
              d="M5.88928 101.33C33.6599 95.4798 101.397 93.9086 150.178 134.427C211.155 185.076 229.59 191.093 264.333 195.607C299.076 200.12 337.718 212.657 362.889 241.24"
              stroke="url(#paint3_linear_25:218)"
            />
            <path
              d="M-22.1107 101.33C5.65989 95.4798 73.3965 93.9086 122.178 134.427C183.155 185.076 201.59 191.093 236.333 195.607C271.076 200.12 309.718 212.657 334.889 241.24"
              stroke="url(#paint4_linear_25:218)"
            />
            <path
              d="M-53.1107 101.33C-25.3401 95.4798 42.3965 93.9086 91.1783 134.427C152.155 185.076 170.59 191.093 205.333 195.607C240.076 200.12 278.718 212.657 303.889 241.24"
